<?php
    ...
    if($flag){
        ...
        $fileUrl = "./upload/profile_image/{$newFileName}";
        ...
        if($uploadResult){
            ...
            $insertImageData = $userDataManager->updateProfileImage(
                $userId,
                $newFileName
            );
...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-12 mt-5">
            <h2>プロフィール画像を設定する</h2>
            <p>正方形の写真を使ってください。イメージは丸く切り取られて使用されます。</p>
        </div>
